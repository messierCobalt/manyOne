...
if os.name != "nt":
    """
    they don't allow navigating through history in linux
    """
    import readline # now they do
...
registry = {} # It'll store the cmd with their respictive fn!
