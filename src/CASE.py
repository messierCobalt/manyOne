...
def camel(words: list) -> str:
    ...
    theOthers = pascal(words[1:]) # justAnotherKidmanMovie...yet2watch!!!
...
def jump(words: list | str, style: str) -> str:
    ...
    """
    words = toLis(words)
    key = flatcase(style) # theKeyIsOnlyTheBeginning... whereeverItLeads... whateverItTakesToGetThere...
    ...
    while True:
        ...
        if userInput == "test":
            ...
            for case in [
                ...
                "snake", "const", "kebab", "dot", "path", "train",
                "random", "cul", "altcul"
            ]:
